...
class WilliamsFamilyProject(info: ProjectInfo) extends DefaultWebProject(info)
{
  ...
  val ratio = "net.fyrie" %% "ratio-datatype" % "1.0-SNAPSHOT" % "compile"

  val slf4japi = "org.slf4j" % "slf4j-api" % "1.6.0"
  val jcloverslf4j = "org.slf4j" % "jcl-over-slf4j" % "1.6.0"
  val log4joverslf4j = "org.slf4j" % "log4j-over-slf4j" % "1.6.0"
